    ...
    _standalone(false)
{
    ui.setupUi(this);
    initAutoWidgets();
    ui.addAccountButton->setIcon(QuasselQIcon::fromTheme("list-add"));
    ui.editAccountButton->setIcon(QuasselQIcon::fromTheme("document-edit"));
    ui.deleteAccountButton->setIcon(QuasselQIcon::fromTheme("edit-delete"));
